...
export const QueryForm = () => {
    ...
    const onSubmit = (ev: FormEvent<HTMLFormElement>) => {
        ...
        ev.stopPropagation();
        const id = fakeId();
        const query = ev.currentTarget.elements.namedItem('name') as HTMLInputElement;
        saveQuery({
            id,
            text: query.value,
        });
    ...
    >
     <Input
      ...
      />
      <Button className="min-w-[50px] shadow-sm" radius="sm" size="lg" color="primary" type="submit">Run Query</Button>
      </Form>
}